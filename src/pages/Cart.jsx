      ...
      <div class="cart">
        ...
        <div class="content__items">
          <div class="cart__item">
            <div class="cart__item-img">
              <img
                class="honey-block__image"
                src="https://images.unsplash.com/photo-1619321652902-a8c183e6cdf2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8aG9uZXl8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
                alt="Honey"
              />
            </div>
        ...
        <div class="cart__bottom">
          <div class="cart__bottom-details">
            <span> Всего заказано: <b>2 шт.</b> </span>
            <span> Сумма заказа: <b> 4800 ₽</b> </span>
          </div>
